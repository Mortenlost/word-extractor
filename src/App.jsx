        ...
        <div>
            ...
            <div className="fixed top-0 left-0 w-screen h-screen z-10 pl-5">
                ...
                <form className="mt-5">
                    ...
                    }} ref={refUrl} className={`w-full mb-2 rounded p-2 text-lg text-gray-700 placeholder-gray-700 font focus:outline-none ${valid ? "" : "border-2 border-red-600"}`} type="text" name="url" placeholder="URL" />
                    <input ref={refLetter} className="w-full mb-2 rounded p-2 text-lg text-gray-700 placeholder-gray-700 font focus:outline-none" type="text" name="letter" placeholder="Letter" />
